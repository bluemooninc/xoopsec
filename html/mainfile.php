...
if ( !defined("XOOPS_MAINFILE_INCLUDED") ) {
    ...
    // Example: define('XOOPS_ROOT_PATH', '/Users/bluemooninc/PhpstormProjects/gmopg/html');
    define('XOOPS_ROOT_PATH', '/Users/bluemooninc/PhpstormProjects/gmopg/html');
    ...
    define('XOOPS_TRUST_PATH', '/Users/bluemooninc/PhpstormProjects/gmopg/xoops_trust_path');

    // XOOPS Virtual Path (URL)
    // Virtual path to your main XOOPS directory WITHOUT trailing slash
    // Example: define('XOOPS_URL', 'http://localhost/gmopg/html');
    define('XOOPS_URL', 'http://localhost/gmopg/html');
