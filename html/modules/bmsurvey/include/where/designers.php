...
# $Id: designers.php,v 1.1.1.1 2005/08/10 12:14:03 yoshis Exp $

// Written by James Flemer
// <jflemer@alum.rpi.edu>
// <jflemer@acm.rpi.edu>

	$sql = "SELECT uid, fname, lname, realm, disabled, expiration FROM ".TABLE_DESIGNER;
	...
	$sql .= ' ORDER BY ';
	$base = $GLOBALS['FMXCONFIG']['manage'] .'?where=designers';
...
?>
<h2><?php echo(_MB_Manage_Web_Form_Designer); ?></h2>
...
?>
	<tr bgcolor="<?php echo($bg); ?>">
		<td>
			<a href="<?php echo($GLOBALS['FMXCONFIG']['manage'] ."?where=admdesigner&u=$u&r=$r"); ?>"><?php echo($u); ?></a>
		</td>
	...
	<tr bgcolor="<?php echo($bg); ?>">
		<th colspan="5" align="center">
			<table border="0" cellpadding="4">
				<tr>
					<th>
					<a href="<?php echo($GLOBALS['FMXCONFIG']['manage'] ."?where=admdesigner"); ?>">
						<?php echo(_MB_Add_a_new_Designer); ?>
					</a>
					</th>
					<th>
					<a href="<?php echo($GLOBALS['FMXCONFIG']['manage'] ."?where=upload&account_type=designers"); ?>">
						<?php echo(_MB_Bulk_Upload_Designers); ?>
					</a>
					</th>
				</tr>
			</table>
