...
cloneFileFolder('modules/myshop');

echo "Happy cloning...\n";
echo "check directory modules/" . $patterns['myshop'] . " for cloned module \n";
echo "Consider modifying new module by editing language/english/modinfo.php and images/myshop_logo.png manually (if you care)\n";
