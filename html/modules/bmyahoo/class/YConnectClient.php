...
class YConnectClient
{
     ...
     */
    public function requestAuth( $redirect_uri, $state, $nonce, $response_type, $scope = null, $display = null, $prompt = null, $getUrl=false )
    {
	    ...
	    if (!$getUrl){
		    ...
		    return $auth_client->requestAuthorizationGrantUrl( $redirect_uri, $state );
	    }
    }
