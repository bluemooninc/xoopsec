...
<h3>1. bmsurvey_formテーブルをバックアップ</h3>
<p>現在使用している bmsurvey_formテーブルをバックアップしてください。 ('xoops_'はXOOPS接頭語です。)

<h3>2. バックアップファイルの編集</h3>
<p><li>Text Editorでバックアップファイルを開いてください。
<p><li>bmsurvey_formテーブルの定義に対して'changed'の１つ下の行に以下の定義を加えてください。
