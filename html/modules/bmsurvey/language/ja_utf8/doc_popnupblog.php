...
<li>予め、ブログを準備して投稿元メールアドレスにアンケートの一般設定に登録したアドレスを設定します。作成したブログのブログＩＤをメモします。
<li>アンケートの編集でGeneralを開きタイトルに b + ブログＩＤ + , を付与します。
<br>
　　例) b1,ブログＩＤ１へ投稿するタイトル
<br>
<li>EmailにPopnupBlogの受信用メールアドレスを設定します。
<li>From Optionに「アンケートのアドレス」を設定します。

<h2>２：ユーザ毎のブログに回答を記録する</h2>
<li>予め、ブログを準備して投稿元メールアドレスにユーザのメールアドレスを設定します。作成したブログのブログＩＤをメモします。
<li>アンケートの編集でQuestionsを開き、質問項目を追加します。任意のフィールドネームで質問テキスト[blogid]タイプ[numeric]必須項目[はい]で質問を作成します。
<li>EmailにPopnupBlogの受信用メールアドレスを設定します。
<li>From Optionに「登録ユーザのアドレス」を設定します。

<h2>３：注意事項</h2>
<li>PopnupBlogとMulti-Formのどちらでもメール処理を行うには２つのメールアドレスが必要になります。
<?php
	xoops_cp_footer();
?>
