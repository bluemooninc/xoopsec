...
// アプリケーションID, シークレッvト
$client_id     = "hogehogehogehogehogehogehogehogehogehogehogehogehogehogehogehoge";
$client_secret = "hogehogehogehogehoge";

// 各パラメータ初期化
$redirect_uri = "http://[your site]/modules/bmyahoo/class/sample.php";
