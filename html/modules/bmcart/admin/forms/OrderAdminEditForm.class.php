...
class bmcart_OrderAdminEditForm extends XCube_ActionForm
{
	...
	function prepare()
	{
		...
		$this->mFormProperties['shipping_memo'] = new XCube_TextProperty('shipping_memo');
	...
	function load(&$obj)
	{
		...
		$this->set('shipping_memo', $obj->get('shipping_memo'));
	}
	...
	function update(&$obj)
	{
		...
		$obj->set('shipping_memo', $this->get('shipping_memo'));
	}
}
